...
import com.erestaurant.gateway.config.EmbeddedKafka;
...
class ERestaurantGatewayKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/e-restaurant-gateway-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/e-restaurant-gateway-kafka/consume")
