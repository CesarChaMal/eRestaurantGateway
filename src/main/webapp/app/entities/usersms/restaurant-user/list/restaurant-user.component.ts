...
export class RestaurantUserComponent implements OnInit {
  restaurantUsers?: IRestaurantUser[];
  isLoading = false;
  totalItems = 0;
  ...
  delete(restaurantUser: IRestaurantUser): void {
    const modalRef = this.modalService.open(RestaurantUserDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.restaurantUser = restaurantUser;
  ...
  protected onSuccess(data: IRestaurantUser[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
